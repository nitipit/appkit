...
# AppKit documentation build configuration file, created by
...
epub_title = u'AppKit'
epub_author = u'Nitipit Nontasuwan'
epub_publisher = u'Nitipit Nontasuwan'
epub_copyright = u'2012, Nitipit Nontasuwan'
